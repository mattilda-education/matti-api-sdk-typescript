...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/programs/{programID}',
};

export const tool: Tool = {
  name: 'retrieve_programs',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nBrinda información detallada sobre un programa específico, identificado por su ID.\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/program',\n  $defs: {\n    program: {\n      type: 'object',\n      properties: {\n        campus_period_id: {\n          type: 'string'\n        },\n        external_id: {\n          type: 'string'\n        },\n        metadata: {\n          type: 'object',\n          description: 'Campo arbitrario de datos de terceros'\n        },\n        name: {\n          type: 'string'\n        },\n        programID: {\n          type: 'string'\n        }\n      }\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      programID: {
    ...
    required: ['programID', 'campusID', 'periodID'],
  },
  annotations: {
    readOnlyHint: true,
  },
...
export const handler = async (client: Matti, args: Record<string, unknown> | undefined) => {
  const { programID, jq_filter, ...body } = args as any;
  return asTextContentResult(await maybeFilter(jq_filter, await client.programs.retrieve(programID, body)));
};
