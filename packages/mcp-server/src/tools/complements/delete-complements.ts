...
export const tool: Tool = {
  name: 'delete_complements',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nElimina un Complemento\n\n# Response Schema\n```json\n{\n  type: 'object',\n  properties: {\n    message: {\n      type: 'string',\n      description: 'Complemento escolar eliminado'\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      complementID: {
    ...
    required: ['complementID', 'campusID', 'periodID'],
  },
};

export const handler = async (client: Matti, args: Record<string, unknown> | undefined) => {
  const { complementID, ...body } = args as any;
  return asTextContentResult(await maybeFilter(args, await client.complements.delete(complementID, body)));
};
