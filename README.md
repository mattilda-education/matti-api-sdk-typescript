...
[![NPM version](<https://img.shields.io/npm/v/mattil.svg?label=npm%20(stable)>)](https://npmjs.org/package/mattil) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/mattil)
...
```sh
npm install git+ssh://git@github.com:mattilda-education/matti-api-sdk-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install mattil`
...
const { data: schools, response: raw } = await client.schools.list().withResponse();
...
We are keen for your feedback; please open an [issue](https://www.github.com/mattilda-education/matti-api-sdk-typescript/issues) with questions, bugs, or suggestions.
